...
public class GameFlowManager : MonoBehaviour
    {
        ...
        {
            MessageSystem.MessageManager.RegisterForChannel<AllObjectivesCompleteMessage>(MessageChannels.GameFlow, AllObjectivesCompleteMessageHandler);
            MessageSystem.MessageManager.RegisterForChannel<PlayerDeathMessage>(MessageChannels.Player, PlayerDeathMessageHandler);
        }

        private void OnDisable()
        {
            MessageSystem.MessageManager.UnregisterForChannel<AllObjectivesCompleteMessage>(MessageChannels.GameFlow, AllObjectivesCompleteMessageHandler);
        ...
        private void AllObjectivesCompleteMessageHandler(MessageSystem.IMessageEnvelope message)
        {
            if(!message.Message<AllObjectivesCompleteMessage>().HasValue) return;
            EndGame(true);
        ...
        void EndGame(bool win)
        {
            ...
            if (win)
            {
                ...
                MessageSystem.MessageManager.SendImmediate(MessageChannels.UI, new DisplayMessage(WinGameMessage, DelayBeforeWinMessage));
            }
            else
            {
