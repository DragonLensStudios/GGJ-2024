    ...
    public class DetectionModule : MonoBehaviour
    {
        ...
        public virtual void HandleTargetDetection(Actor actor, Collider[] selfColliders)
        {
            ...
            foreach (Actor otherActor in m_ActorsManager.Actors)
            {
                ...
                switch (HadKnownTarget)
                {
                    // Detection events
                    case false when KnownDetectedTarget != null:
                        MessageSystem.MessageManager.SendImmediate(MessageChannels.AI, new TargetDetectionMessage(DetectionType.Detected, otherActor.gameObject));
                        break;
                    case true when KnownDetectedTarget == null:
                        MessageSystem.MessageManager.SendImmediate(MessageChannels.AI, new TargetDetectionMessage(DetectionType.Lost, otherActor.gameObject));
                        break;
                }
            }
