...
namespace DLS.UI
{
    public class ObjectiveToast : MonoBehaviour
    {
        ...
        public void Initialize(string titleText, string descText, string counterText, bool isOptionnal, float delay)
        {
            ...
            m_StartFadeTime = UnityEngine.Time.time + delay;
            // start the fade in
            m_IsFadingIn = true;
            m_IsMovingIn = true;
        }
        ...
        {
            m_StartFadeTime = UnityEngine.Time.time + CompletionDelay;
            m_IsFadingIn = false;
            m_IsMovingIn = false;
        ...
        void Update()
        {
            float timeSinceFadeStarted = UnityEngine.Time.time - m_StartFadeTime;
